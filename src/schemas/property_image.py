...
class ImageBase(BaseModel):
    ...
    calculated_tags: Optional[Dict[str, Any]] = Field(
        None, description="AI-generated tags for the image"
    )
...
class ImageUpdate(BaseModel):
    ...
    property_id: Optional[int] = Field(
        None, gt=0, description="ID of the associated property"
    )
    img_url: Optional[str] = Field(
        None, min_length=1, max_length=1000, description="Image URL"
    )
    calculated_tags: Optional[Dict[str, Any]] = Field(
        None, description="AI-generated tags for the image"
    )
...
class ImageBulkCreate(BaseModel):
    ...
    image_urls: List[str] = Field(
        ..., min_length=1, max_length=50, description="List of image URLs"
    )
...
class ImageTagsUpdate(BaseModel):
    ...
    calculated_tags: Dict[str, Any] = Field(
